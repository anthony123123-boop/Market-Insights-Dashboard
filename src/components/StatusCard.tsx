  ...
  return (
    <FrostedCard className="h-full flex flex-col" glowColor={colors.hex}>
      ...
      <div className="py-4 border-b border-white/10">
        <div className="text-[11px] text-cyan-400/80 uppercase tracking-widest mb-2 font-medium">
          Plan of Action
        </div>
      ...
      <div className="flex-1 py-3 overflow-y-auto">
        <div className="text-[11px] text-cyan-400/80 uppercase tracking-widest mb-3 font-medium">
          Key Drivers
        </div>
